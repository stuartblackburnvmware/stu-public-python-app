...
```json
{
  ...
  "includeTap" : true,
  "interfaceType" : "http",
  "projectName" : "stu-public-python-app"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [python-function->stu-public-python-app, main->main]
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [python-function->stu-public-python-app]
